  ...
  kids: {
    level_infantil: {
      belts: [
        ...
        { belt: 'yellow-white', stripeEvery: 30, maxStripes: 4 },
        { belt: 'yellow', stripeEvery: 30, maxStripes: 4 },
        { belt: 'yellow-black', stripeEvery: 30, maxStripes: 4 },
        { belt: 'orange-white', stripeEvery: 30, maxStripes: 4 },
        { belt: 'orange', stripeEvery: 30, maxStripes: 4 },
        { belt: 'orange-black', stripeEvery: 30, maxStripes: 4 },
