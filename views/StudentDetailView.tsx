...
import { ArrowLeft, Mail, Calendar, Award, TrendingUp, Clock, Video } from 'lucide-react';
...
const StudentDetailView: React.FC<StudentDetailViewProps> = ({ student, onBack }) => {
  // Calculate age if birthDate exists, else mock
  const age = student.birthDate ? new Date().getFullYear() - new Date(student.birthDate).getFullYear() : 28;
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-2 text-right">
              Faltam {student.classesToNextStripe - student.currentStripeProgress} aulas
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-2 text-right">
              Faltam {student.totalClassesToNextBelt - student.currentBeltProgress} aulas
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">{student.startDate || '15/03/2022'}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-sm font-medium">Última Graduação (Faixa)</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">{student.lastGraduation}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">{student.lastStripeDate || '10/01/2024'}</p>
            </div>
          </div>
        </div>
      </div>
